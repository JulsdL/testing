    ...
    def _run(self, paragraphs: List[str]) -> str:
        ...
        system_msg = {
            ...
            "content": (
                ...
                "to replace with a FALC version.  \n"
                "Ignore any header (addresses, logos, dates) and footer (salutations, signatures).  \n"
                "Return exactly two numbers: replace_start (the first paragraph of the main content) "
                "and replace_end (the last paragraph before any closing)."
            )
        }
        ...
        user_msg = {
            ...
            "content": (
                ...
                f"{numbered}\n\n"
                "Please respond *only* with valid JSON like:\n"
                "{ \"replace_start\": X, \"replace_end\": Y }"
            )
        }
